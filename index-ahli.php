                    ...
                    <tbody>
                      ...
                      ?>
                        <tr>
                          ...
                          <td>
                            <a href="form-show-ahli.php?id_ahli=<?php echo $pecah['id_ahli']; ?>"><span data-toggle="tooltip" title="lihat detail data"class="btn btn-success bi bi-search font-hijau"></span></a>
                            <a href="form-edit-ahli.php?id_ahli=<?php echo $pecah['id_ahli']; ?>"><span data-toggle="tooltip" title="edit data" class="btn btn-success bi bi-pencil-square font-hijau"></span></a>
                            <a href="function/delete-ahli.php?id_ahli=<?php echo $pecah['id_ahli']; ?>"><span data-toggle="tooltip" title="hapus data" class="btn btn-success bi bi-trash font-hijau"></span></a>
